module Example.View.Tab exposing
    ( Choice
    , Options
    , Theme
    , view
...
--         , options.viewCaret
--         , viewHtmlRadio options value choiceTextToValue
--         ]
-- viewHtmlRadio : Options value msg -> value -> Dict String value -> Html msg
-- viewHtmlRadio options value choiceTextToValue =
--     let
--         onInput text =
...
--     in
--     List.map (viewChoice options value) options.choices
--         |> Html.div []
-- viewChoice : Options value msg -> value -> Choice value -> Html msg
-- viewChoice options value choice =
--     let
--         onInput text =
--             Dict.get text choiceTextToValue
--                 |> options.onInput
